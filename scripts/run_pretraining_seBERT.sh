...
train_steps=${11:-7820}
save_checkpoints_steps=${12:-50}
num_accumulation_steps_phase1=${13:-128}
num_accumulation_steps_phase2=${14:-256}
bert_model=${15:-"large"}
...
if [ "$bert_model" = "large" ] ; then
    export BERT_CONFIG=bert_config.json
else
...
train_steps_phase1=$(expr $train_steps) #Phase 1 is 100% of training
...
for DIR_or_file in $DATA_DIR $RESULTS_DIR_PHASE1 $BERT_CONFIG; do
 ...
 $mpi python /workspace/sebert/run_pretraining.py \
